...
export default {
  ...
  props: {
    ...
    message: {
      type: String,
      default: `Ce site utilise des cookies internes, uniquement pour son fonctionnement.
        Aucun cookies ni aucune informations saisies sur les sites du domaine ikodi.eu ne sont utilisés à des fins commerciales.`,
    },
    // button
    linkLabel: {
      type: String,
    ...
    href: {
      type: String,
      default: "https://www.cnil.fr/fr/definition/cookie",
    },
    target: {
      type: String,
      default: "_blank",
